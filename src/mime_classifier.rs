...
use crate::net_traits::LoadContext;
use mime::{self, Mime};
...
impl Clone for GroupedClassifier {
    fn clone(&self) -> Self {
        match self.classifier_type {
            ClassifierType::Image => {
                return GroupedClassifier::image_classifer();
            }
            ClassifierType::AudioVideo => {
                return GroupedClassifier::audio_video_classifier();
            }
            ClassifierType::Scriptable => {
                return GroupedClassifier::scriptable_classifier();
            }
            ClassifierType::Plaintext => {
                return GroupedClassifier::plaintext_classifier();
            }
            ClassifierType::Archive => {
                return GroupedClassifier::archive_classifier();
            }
            ClassifierType::Font => {
                return GroupedClassifier::font_classifier();
            }
        }
    }
}

impl std::fmt::Debug for GroupedClassifier {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("GroupedClassifier").finish()
    }
}
...
impl GroupedClassifier {
    fn image_classifer() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::Image,
            byte_matchers: vec![
    ...
    fn audio_video_classifier() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::AudioVideo,
            byte_matchers: vec![
    ...
    fn scriptable_classifier() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::Scriptable,
            byte_matchers: vec![
    ...
    fn plaintext_classifier() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::Plaintext,
            byte_matchers: vec![
    ...
    fn archive_classifier() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::Archive,
            byte_matchers: vec![
    ...
    fn font_classifier() -> GroupedClassifier {
        GroupedClassifier {
            classifier_type: ClassifierType::Font,
            byte_matchers: vec![
